...
const EXAMPLE_TITLES = [
  "Рыжий кот на подоконнике", "Горы на закате", "Дождь над городом",
  "Щенок в свежем снегу", "Старый маяк у моря", "Осенняя аллея",
  "Ночные огни мегаполиса", "Полевые ромашки", "Гоночный болид на треке",
  "Созвездие над пустыней", "Хвойный лес в тумане", "Львёнок в саванне",
];
...
Правила: 2-4 слова каждое, как подпись к картинке в каталоге (например ${pickExamples()}). Избегай шаблонных штампов вроде "X на закате"/"X крупным планом" — называй то, что конкретно отличает ИМЕННО эту сцену (порода/вид, цвет, действие, место, настроение), а не первое общее слово по теме. Английское — с большой буквы у каждого слова (Title Case). Без кавычек внутри строк, без точки в конце, без слов вроде "пазл"/"puzzle".`;
